...
import { AppAdminsFieldsResolvers } from './app-admins';
import { AppInstructorsFieldsResolvers } from './app-instructors';
...
export const FieldsResolvers = [
  ...
  ...AppAdminsFieldsResolvers,
  ...AppInstructorsFieldsResolvers
];
