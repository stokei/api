...
type SendSubscriptionCanceledEmailCommandKeys =
  keyof SendSubscriptionCanceledEmailCommand;

@CommandHandler(SendSubscriptionCanceledEmailCommand)
export class SendSubscriptionCanceledEmailCommandHandler
  implements ICommandHandler<SendSubscriptionCanceledEmailCommand>
{
  private readonly logger = new Logger(
    SendSubscriptionCanceledEmailCommandHandler.name
  );
  constructor(
  ...
  async execute(command: SendSubscriptionCanceledEmailCommand) {
    ...
    try {
      ...
      if (!data?.app) {
        throw new ParamNotFoundException<SendSubscriptionCanceledEmailCommandKeys>(
          'app'
        );
      }
      if (!data?.toAccount) {
  ...
  private clearData(
    command: SendSubscriptionCanceledEmailCommand
  ): SendSubscriptionCanceledEmailCommand {
    return cleanObject({
