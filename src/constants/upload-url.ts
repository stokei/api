...
export const LOCAL_UPLOAD_VIDEO_URL_PATHNAME = `${LOCAL_UPLOAD_BASE_PATHNAME}/${REST_CONTROLLERS_URL_NAMES.UPLOADS_VIDEOS_DEVELOPMENT}`;
...
export const LOCAL_UPLOAD_IMAGE_URL = appendPathnameToURL(
  SERVER_URL,
  `${LOCAL_UPLOAD_BASE_PATHNAME}/${REST_CONTROLLERS_URL_NAMES.UPLOADS_IMAGES}`
);
